...
function prd_sub() {
  ...
  if (output_check == 0) {
	//**********************this comment when Q/A available************
	 document.getElementById('start1').value = "/usr/Factory/machines/machine8/table2_es.shtm";
	//**********************END****************************	
...
function prd_sub1() {
  ...
  if (output_check == 0) {
	//**********************this comment when Q/A available************
	document.getElementById('start2').value = "/usr/Factory/machines/machine8/table2_es.shtm";
	//**********************END****************************	
...
function subform() {
	...
	//**************comment this when Q/A AVAILABLE ****************
	 document.getElementById('qtr1').value = "/usr/Factory/machines/machine8/table2_es.shtm";
	//***************************END********************
	...
	if (prod_info == "Nil") {
		...
		if ((document.getElementById("qty1").value == "") || (document.getElementById("qty1").value ==0)) {
			...
			//document.getElementById('qtr1').value = "/usr/Factory/machines/machine8/index3.shtm?" + kg;
			//***********************END******************
			swal({
...
function subform1() {
		...
		//**************comment this when Q/A AVAILABLE ****************
	 document.getElementById('qtr2').value = "/usr/Factory/machines/machine8/table2_es.shtm";
	//***************************END********************
	...
	if (prod_info == "Nil") {
		...
		if ((document.getElementById("qty2").value == "") || (document.getElementById("qty2").value ==0)) {
			...
			var kg = document.getElementById("qty2").value;
			 //document.getElementById('qtr2').value = "/usr/Factory/machines/machine8/index3.shtm?" + kg;
			//***********************END******************
			swal({
				title: "¡Producto enviado correctamente!",
				type: "success",
