...
for (var i = 0; i < product_list.length; i++) {
	...
	document.getElementById('start1').value = "/usr/Factory/machines/machine9/table2.shtm";
	//**********************END****************************
...
for (var i = 0; i < product_list.length; i++) {
	...
	{
	//**********************this comment when Q/A available************
	document.getElementById('start2').value = "/usr/Factory/machines/machine9/table2.shtm";
	//**********************END****************************
...
function subform() {
	//**************comment this when Q/A AVAILABLE ****************
	 document.getElementById('qtr1').value = "/usr/Factory/machines/machine9/table2.shtm";
	//***************************END********************
...
function subform1() {
		//**************comment this when Q/A AVAILABLE ****************
	document.getElementById('qtr2').value = "/usr/Factory/machines/machine9/table2.shtm";
	//***************************END********************
