...
function prd_sub() {
   ...
   if (output_check == 0) {
    ...
    document.getElementById('start1').value = "/usr/Factory/machines/machine11/table2.shtm";
      //**********************END****************************
      ...
      swal({
         title: "Output ref. Id. Exist",
         text: "Please ensure that Output ref. Id unique!!",
         type: "warning",
         showCancelButton: true,
         confirmButtonClass: 'btn-warning',
         confirmButtonText: 'Ok'
...
function prd_sub1() {
  ...
  for (var i = 0; i < product_list.length; i++) {
   ...
   if (output_check == 0) {
      ...
      //**********************this comment when Q/A available************
   document.getElementById('start2').value = "/usr/Factory/machines/machine11/table2.shtm";
      //**********************END****************************
...
function subform() {
   //**************comment this when Q/A AVAILABLE ****************
    document.getElementById('qtr1').value = "/usr/Factory/machines/machine11/table2.shtm";
   //***************************END********************
...
function subform1() {
   //**************comment this when Q/A AVAILABLE ****************
    document.getElementById('qtr2').value = "/usr/Factory/machines/machine11/table2.shtm";
   //***************************END********************
   var prod_info = document.getElementById("out_code1").innerHTML;
   if (prod_info == "Nil") {
      swal({
...
function reason_sub() {
  ...
  if("Select Reason"==reason1) { reason1=""; }
  if("Select Minor Reason"==reason2) { reason2=""; }
  if("Select Sub Minor Reason"==reason3) { reason3=""; }
  if("Select sub sub Minor Reason"==reason4) { reason4=""; }
