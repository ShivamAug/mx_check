...
$(document).ready(function () {
	...
	$("#pop_sub4").hide();
	$("#pop_sub3").hide();
	$.get("../../../sdext/Management_report/data/ref.csv?" + random_number, function (data) {
	...
	for (var i = 0; i < product_list.length; i++) {
		...
		if (product_list[i].match(input1)) {
			...
			document.getElementById("status").innerHTML = "Output ref. id exist please enter correct Output ref. id";
			document.getElementById("status").style.color = "Red";
			$("#but_save1").hide();
			break;
		} else {
			document.getElementById("status").innerHTML = "Success !! ok";
	...
	for (var i = 0; i < product_list.length; i++) {
		if (product_list[i].match(input1)) {
			document.getElementById("status1").innerHTML = "Output ref. id exist please enter correct Output ref. id";
			document.getElementById("status1").style.color = "Red";
			$("#but_save2").hide();
			break;
		} else {
			document.getElementById("status1").innerHTML = "Success !! ok";
...
function output() {
	...
	for (var i = 0; i < output_product.length; i++) {
		if (output_product[i][5].match(inp)) {
...
function out_product_check() {
	...
	for (var i = 0; i < product_list.length; i++) {
		...
		if (product_list[i].match(input1)) {
			...
			console.log(product_list[i]+"--"+input1);
			document.getElementById("status").innerHTML = "Success !! ok";
			document.getElementById("status").style.color = "Green";
			$("#but_save1").show();
		}
...
function prd_sub() {
	...
	// document.getElementById('start1').value = "/usr/Factory/machines/machine1/table2.shtm";
	//**********************END****************************	

//*********************comment when Q/a Not in system******************

		var ddt1 = document.getElementById("json_date").value;
		var Shop = document.getElementById("json_station").value;
		var Machine = document.getElementById("json_machine").value;
		var Operator = document.getElementById("json_operator").value;
		var Qty = document.getElementById("json_inpqty").value;
		var Start_shift =document.getElementById("json_shift").value;
		var Stage = "1";
		var out_ref_id = document.getElementById('out_value').value;
		var output_product = document.getElementById('out_pro_co').value;
		var inp_ref_id = document.getElementById('coil_run').value;
		var work_order = "1";
		var ctp = document.getElementById("ctpdata").value;
		var data1 = ddt1 + "," + Stage + "," + Shop + "," + Machine + "," + Operator + "," + out_ref_id + "," + output_product + "," + inp_ref_id + "," + work_order + "," + Qty + "," + Start_shift;
		if (output_product == "Nil") {
			document.getElementById('start1').value = "/usr/Factory/machines/machine1/table2.shtm";
		} else {
			document.getElementById('start1').value = "/usr/Factory/machines/machine1/index2.shtm?" + data1 + "#" + ctp;
		}
//  *********************END*************************
	...
	if (document.getElementById("out_input1").value == "") {
		swal({
			title: "Enter Output ref. Id.",
			text: "Please ensure that all field filled correctly!!",
			type: "warning",
		...
		swal({
			title: "Product Start Successfully!",
			type: "success",
			showCancelButton: true,
...
var input1 = document.getElementById("out_value1").value;
	document.getElementById("out_input2").value = input1;
	//**********************this comment when Q/A available************
	//document.getElementById('start2').value = "/usr/Factory/machines/machine1/table2.shtm";
	//**********************END****************************	
...
//*********************comment when Q/a Not in system******************
		...
		var Start_shift =document.getElementById("json_shift").value;
		var Stage = "1";
		var out_ref_id = document.getElementById('out_value1').value;
		var output_product = document.getElementById('out_pro_co1').value;
		var inp_ref_id = document.getElementById('coil_run1').value;
		var work_order = "1";
		var ctp = document.getElementById("ctpdata").value;
		var data1 = ddt1 + "," + Stage + "," + Shop + "," + Machine + "," + Operator + "," + out_ref_id + "," + output_product + "," + inp_ref_id + "," + work_order + "," + Qty + "," + Start_shift;
		if (output_product == "Nil") {
			...
			document.getElementById('start2').value = "/usr/Factory/machines/machine1/index2.shtm?" + data1 + "#" + ctp;
		}
//  *********************END*************************
...
function reset1() {
	...
	swal({
		title: "Product Reset Successfully!",
		type: "success",
		showCancelButton: true,
		confirmButtonClass: 'btn-success',
		confirmButtonText: 'Success!'
...
function subform() {
	...
	// document.getElementById('qtr1').value = "/usr/Factory/machines/machine1/table2.shtm";
	//***************************END********************
	...
	if (prod_info == "Nil") {
		swal({
			title: "Please Reset Nil Product",
			text: "Please reset Nil product by using above Reset Button",
			type: "warning",
			showCancelButton: true,
			confirmButtonClass: 'btn-warning',
			confirmButtonText: 'Ok'
		...
		if ((document.getElementById("qty1").value == "") || (document.getElementById("qty1").value ==0)) {
			swal({
				title: "Please Enter Kg",
				text: "Please Enter Kg or Kg is greater than 0 ",
				type: "warning",
				showCancelButton: true,
				confirmButtonClass: 'btn-warning',
				confirmButtonText: 'Ok'
			...
			document.getElementById('qtr1').value = "/usr/Factory/machines/machine1/index3.shtm?" + kg;
			//***********************END******************
			swal({
...
function subform1() {
		...
		//**************comment this when Q/A AVAILABLE ****************
	// document.getElementById('qtr2').value = "/usr/Factory/machines/machine1/table2.shtm";
	//***************************END********************
	...
	if (prod_info == "Nil") {
		...
		if ((document.getElementById("qty2").value == "") || (document.getElementById("qty2").value ==0)) {
			...
			var kg = document.getElementById("qty2").value;
			 document.getElementById('qtr2').value = "/usr/Factory/machines/machine1/index3.shtm?" + kg;
			//***********************END******************
			swal({
				title: "Product Submitted Successfully!",
				type: "success",
...
function shift_opt() {
	...
	if (opt_value === document.getElementById("opt_checker").value) {
		swal({
			title: "Please Select Running Shift Operator Name",
			text: "Please select Running Shift Operator name",
			type: "warning",
			showCancelButton: true,
			confirmButtonClass: 'btn-warning',
			confirmButtonText: 'Ok'
...
function input_sub() {
	...
	var pop_a1 = document.getElementById("supplier_id").value;
	var pop_a2 = document.getElementById("inp_pro_code").value;
	...
	if ((pop_a1 == "") || (pop_a2 == "") || (pop_a3 == "")) {
		...
		swal({
			title: "Input Product Successfully Entered.",
			type: "success",
			showCancelButton: true,
			confirmButtonClass: 'btn-success',
			confirmButtonText: 'Success!'
...
function input_sub2() {
	...
	var pop_a1 = document.getElementById("supplier_id1").value;
	var pop_a2 = document.getElementById("inp_pro_code1").value;
...
function operator1() {
	swal({
		title: "Operator name successfully updated",
		type: "success",
		showCancelButton: true,
		confirmButtonClass: 'btn-success',
		confirmButtonText: 'Success!'
...
function reason_sub()
{
       ...
       {
              swal({
                                      title: "Please Select all Field of Reason",
                                                text: "Please select all 4 downtime reasons",         
                                                 type: "warning",
                                          showCancelButton: true,
          confirmButtonClass: 'btn-warning',
          confirmButtonText: 'Ok'
       ...
       swal({
          title: "Downtime Reason Saved Successfully",
          type: "success",
          showCancelButton: true,
          confirmButtonClass: 'btn-success',
          confirmButtonText: 'Success!'
...
function reason_sub1()
{
       ...
       var reason3=document.getElementById("id_parent2").value;
       var reason4=document.getElementById("id_child2").value;
       document.getElementById("major_rd1").value=Math.random()*1000;
       document.getElementById("reason_alt").value=0;
       if((reason1=="")||(reason2=="")||(reason3=="")||(reason4==""))
       {
                swal({
                                      title: "Please Select all Field of Reason",
       ...
       else
       {
          ...
          document.getElementById("error4").value=reason4;
          swal({
          title: "Downtime Reason Submitted Successfully",
          type: "success",
          showCancelButton: true,
          confirmButtonClass: 'btn-success',
          confirmButtonText: 'Success!'
