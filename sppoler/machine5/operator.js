...
function prd_sub() {
	...
	document.getElementById('start1').value = "/usr/Factory/machines/machine5/table2.shtm";
	//**********************END****************************	
...
var input1 = document.getElementById("out_value1").value;
	...
	{
	//**********************this comment when Q/A available************
	document.getElementById('start2').value = "/usr/Factory/machines/machine5/table2.shtm";
	//**********************END****************************	
...
function subform() {
	//**************comment this when Q/A AVAILABLE ****************
	 document.getElementById('qtr1').value = "/usr/Factory/machines/machine5/table2.shtm";
	//***************************END********************
...
function subform1() {
		//**************comment this when Q/A AVAILABLE ****************
	document.getElementById('qtr2').value = "/usr/Factory/machines/machine5/table2.shtm";
	//***************************END********************
