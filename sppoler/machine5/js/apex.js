...
! function (t, e) {
		...
		f = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(n({}, I, {
						speed: p,
						delay: f
					})), A.globals.dataChanged && z && M && C.animatePathsGradually(n({}, I, {
						speed: x
					})), T
				}
			}, {
	...
	var p = {
			...
			return s(t, [{
				...
				value: function (t, e, i) {
					...
					if ("category" === s.config.xaxis.type || s.config.xaxis.convertedCatToNumeric) {
						...
						l && (r = String(l.getAttribute("x")))
					}
					var h = t.strokeDashArray;
					if (!(r < 0 || r > s.globals.gridWidth)) {
						if (null === t.x2) {
							var c = this.graphics.drawLine(r + t.offsetX, 0 + t.offsetY, r + t.offsetX, s.globals.gridHeight + t.offsetY, t.borderColor, h);
							e.appendChild(c.node)
						} else {
							var d = (t.x2 - a) / (n / s.globals.gridWidth);
							if (d < r) {
								var u = r;
								r = d, d = u
							}
							var g = this.graphics.drawRect(r + t.offsetX, 0 + t.offsetY, d - r, s.globals.gridHeight + t.offsetY, 0, t.fillColor, t.opacity, 1, t.borderColor, h);
							e.appendChild(g.node)
						}
						var f = "top" === t.label.position ? -3 : s.globals.gridHeight,
				...
				value: function (t, e, i) {
					...
					} else s = n.globals.gridHeight - (t.y - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight), n.config.yaxis[t.yAxisIndex].reversed && (s = (t.y - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight));
					var h = t.label.text ? t.label.text : "";
					if (null === t.y2) {
						...
						} else a = n.globals.gridHeight - (t.y2 - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight), n.config.yaxis[t.yAxisIndex].reversed && (a = (t.y2 - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight));
						if (a > s) {
							var g = s;
							s = a, a = g
						}
					...
					t.map(function (t, a) {
						if ("vertical" === t.label.orientation) {
							...
							if (null !== r) {
								...
								r.setAttribute("x", String(r.getAttribute("x")) - o.height + 4), "top" === t.label.position ? r.setAttribute("y", String(r.getAttribute("y")) + o.width) : r.setAttribute("y", parseFloat(r.getAttribute("y")) - o.width);
			...
			return s(t, [{
				...
				value: function (t) {
					...
					return i && i.length && (t.xaxis.labels.formatter = function (t) {
						...
						return e(i[t-1])
					}), t.xaxis.categories = [], t.labels = [], t.chart.zoom.enabled = 1, t
				}
			}]), t
		}(),
		v = function () {
			...
			return s(i, [{
				...
				value: function () {
					...
					if (e && "object" === t(e)) {
						...
						"line" !== e.chart.type && "area" !== e.chart.type && "scatter" !== e.chart.type || o.comboChartsHasBars || "datetime" === e.xaxis.type || "between" === e.xaxis.tickPlacement || (e = b.convertCatToNumeric(e)), (e.chart.sparkline && e.chart.sparkline.enabled || window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled) && (r = s.sparkline(r)), n = d.extend(a, r)
					}
			...
			return s(t, [{
				...
				value: function (t, e, i) {
					...
					if (h.attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")), r.x instanceof Array)
						for (var c = 0; c < r.x.length; c++) {
							...
							var x = r.x[c],
								m = r.y[c];
							if (g = g || 0, (0 === x && 0 === m || null === m || void 0 === s.globals.series[n][d]) && (u = !1), u) {
								var b = this.drawPoint(x, m, g, p, n, d, e);
								h.add(b)
							}
							l.add(h)
						}
				...
				value: function (t, e, i, s, a, n, r) {
					...
					if (x.attr({
							...
							cy: e,
							fill: p
						}), o.config.chart.dropShadow.enabled && h.dropShadow(x, {
							top: o.config.chart.dropShadow.top,
							left: o.config.chart.dropShadow.left,
							blur: o.config.chart.dropShadow.blur,
							color: o.config.chart.dropShadow.color,
							opacity: o.config.chart.dropShadow.opacity
						}), this.initialAnim && !o.globals.dataChanged) {
						var m = 1;
						o.globals.resized || (m = o.config.chart.animations.speed), l.animateCircleRadius(x, 0, s, m, o.globals.easing)
					}
					if (o.globals.dataChanged)
						if (this.dynamicAnim) {
							var b, v, y, w, k = o.config.chart.animations.dynamicAnimation.speed;
							null != (w = o.globals.previousPaths[a] && o.globals.previousPaths[a][r]) && (b = w.x, v = w.y, y = void 0 !== w.r ? w.r : s);
							for (var C = 0; C < o.globals.collapsedSeries.length; C++) o.globals.collapsedSeries[C].index === a && (k = 1, s = 0);
							0 === t && 0 === e && (s = 0), l.animateCircle(x, {
								cx: b,
								cy: v,
								r: y
							}, {
					...
					var L = new S(this.ctx);
					return h.setSelectionFilter(x, a, n), L.addEvents(x), x.node.classList.add("apexcharts-marker"), x
				}
			}, {
					...
					for (var d = 0; d < t.x.length; d++)
						if (o = t.x[d] + r.offsetX, l = t.y[d] + r.offsetY - a.globals.markers.size[e] - 5, "bottom" === s && (l = l + 2 * a.globals.markers.size[e] + 1.4 * parseInt(r.style.fontSize)), !isNaN(o)) {
							...
							var u = a.globals.series[e][h],
								g = "";
							if ("bubble" === a.config.chart.type) g = a.globals.seriesZ[e][h], l = t.y[d] + a.config.dataLabels.offsetY, l = new C(this.ctx).centerTextInBubble(l, e, h).y;
							else void 0 !== u && (g = a.config.dataLabels.formatter(u, {
								seriesIndex: e,
								dataPointIndex: h,
								w: a
							}));
							null === g && (g = ""), this.plotDataLabelsText({
								x: o,
								y: l,
								text: g,
								i: e,
		...
		z = function () {
			function t(i, s) {
				e(this, t), this.ctx = i, this.w = i.w;
				var a = this.w;
				this.barOptions = a.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = a.config.stroke.width, this.isNullValue = !1, this.xyRatios = s, null !== this.xyRatios && (this.xRatio = s.xRatio, this.yRatio = s.yRatio, this.invertedXRatio = s.invertedXRatio, this.invertedYRatio = s.invertedYRatio, this.baseLineY = s.baseLineY, this.baseLineInvertedY = s.baseLineInvertedY), this.minXDiff = Number.MAX_VALUE, this.yaxisIndex = 0, this.seriesLen = 0
			}
			return s(t, [{
				key: "draw",
				value: function (t, e) {
					...
					s.config.dataLabels.enabled && this.totalItems > s.config.plotOptions.bar.dataLabels.maxItems && console.warn("WARNING: DataLabels are enabled but there are too many to display. This may cause performance issue when rendering.");
					for (var l = function (r, l) {
							var h, c, u, g, f = void 0,
								p = void 0,
								x = void 0,
								m = void 0,
								b = [],
								...
								w = a.group({
									class: "apexcharts-series ".concat(d.escapeString(s.globals.seriesNames[y])),
									rel: r + 1,
									"data:realIndex": y
								});
							i.ctx.series.addCollapsedClassToSeries(w, y), t[r].length > 0 && (i.visibleI = i.visibleI + 1);
							var k, A, S = 0;
							i.yRatio.length > 1 && (i.yaxisIndex = y), i.isReversed = s.config.yaxis[i.yaxisIndex] && s.config.yaxis[i.yaxisIndex].reversed;
							var C = i.initialPositions();
							m = C.y, k = C.barHeight, c = C.yDivision, g = C.zeroW, x = C.x, A = C.barWidth, h = C.xDivision, u = C.zeroH, i.horizontal || v.push(x + A / 2);
							for (var L = a.group({
									class: "apexcharts-datalabels"
								}), z = function (e, a) {
									void 0 === i.series[r][e] || null === t[r][e] ? i.isNullValue = !0 : i.isNullValue = !1, s.config.stroke.show && (S = i.isNullValue ? 0 : Array.isArray(i.strokeWidth) ? i.strokeWidth[y] : i.strokeWidth);
									var o = null;
									o = i.isHorizontal ? i.drawBarPaths({
										...
										strokeWidth: S,
										elSeries: w
									}), f = o.pathTo, p = o.pathFrom, m = o.y, x = o.x, e > 0 && v.push(x + A / 2), b.push(m);
									var d = i.barOptions.distributed ? e : r,
										C = null;
									i.barOptions.colors.ranges.length > 0 && i.barOptions.colors.ranges.map(function (i) {
										t[r][e] >= i.from && t[r][e] <= i.to && (C = i.color)
									});
									var z = n.fillPath({
										seriesNumber: i.barOptions.distributed ? d : y,
										color: C
									});
									w = i.renderSeries({
										realIndex: y,
								...
								}, M = 0, P = s.globals.dataPoints; M < s.globals.dataPoints; M++, P--) z(M);
							s.globals.seriesXvalues[y] = v, s.globals.seriesYvalues[y] = b, o.add(w)
				...
				value: function (t) {
					var e = t.realIndex,
						...
						y = this.w,
						w = new f(this.ctx);
					s || (s = this.barOptions.distributed ? y.globals.stroke.colors[a] : y.globals.stroke.colors[e]), this.isNullValue && (i = "none");
				...
				value: function () {
					...
					return this.isHorizontal ? (a = (i = l.globals.gridHeight / l.globals.dataPoints) / this.seriesLen, l.globals.isXNumeric && (a = (i = l.globals.gridHeight / this.totalItems) / this.seriesLen), a = a * parseInt(this.barOptions.barHeight) / 100, o = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0), e = (i - a * this.seriesLen) / 2) : (n = (s = l.globals.gridWidth / this.visibleItems) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100, l.globals.isXNumeric && (this.calcMinimumXDiff(), n = (s = this.minXDiff / this.xRatio) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100), r = l.globals.gridHeight - this.baseLineY[this.yaxisIndex] - (this.isReversed ? l.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), t = l.globals.padHorizontal + (s - n * this.seriesLen) / 2), {
						x: t,
						y: e,
						yDivision: i,
						xDivision: s,
				...
				value: function () {
					...
					return 1 === t.globals.labels.length ? this.minXDiff = (t.globals.maxX - t.globals.minX) / e / 3 : this.minXDiff === Number.MAX_VALUE && (t.globals.timelineLabels.length > 0 && (e = t.globals.timelineLabels.length), e < 3 && (e = 3), this.minXDiff = (t.globals.maxX - t.globals.minX) / e), this.minXDiff
				}
			}, {
				key: "drawBarPaths",
				value: function (t) {
					...
					a = u.move(r, b), n = u.move(r, b), d.globals.previousPaths.length > 0 && (n = this.getPathFrom(x, p));
					var v = {
							barHeight: i,
							strokeWidth: s,
							barYPosition: b,
				...
				value: function (t) {
					...
					n = u.move(b, l), r = u.move(b, l), d.globals.previousPaths.length > 0 && (r = this.getPathFrom(x, p));
					var v = {
							barWidth: o,
							strokeWidth: h,
							barXPosition: b,
				...
				value: function (t) {
					...
					r -= d / 2, e = i.globals.isXNumeric ? r - o / 2 + u : r - p + o / 2 + u;
					var x = this.series[s][a] <= 0;
					switch (i.config.yaxis[this.yaxisIndex].reversed && (n -= f), c.position) {
						case "center":
							h = x ? n + f / 2 + l.height / 2 + g : n + f / 2 + l.height / 2 - g;
							break;
						case "bottom":
							h = x ? n + f + l.height + d + g : n + f - l.height / 2 + d - g;
							break;
						case "top":
							h = x ? n - l.height / 2 - g : n + l.height + g
					}
					return {
						bcx: r,
						bcy: n,
				...
				value: function (t) {
					var e = this.w,
						...
						p = this.series[s][a] <= 0;
					switch (e.config.yaxis[this.yaxisIndex].reversed && (i += f), c.position) {
						case "center":
							l = p ? i - f / 2 - d : i - f / 2 + d;
							break;
						case "bottom":
							l = p ? i - f - h - Math.round(o.width / 2) - d : i - f + h + Math.round(o.width / 2) + d;
							break;
						case "top":
							l = p ? i - h + Math.round(o.width / 2) - d : i - h - Math.round(o.width / 2) + d
					}
			...
			return r(i, z), s(i, [{
				...
				value: function (t, e) {
					...
					for (var r = this.graphics.group({
							...
							i.yRatio.length > 1 && (i.yaxisIndex = b), i.isReversed = s.config.yaxis[i.yaxisIndex] && s.config.yaxis[i.yaxisIndex].reversed;
							var v, y, w = i.graphics.group({
									class: "apexcharts-series ".concat(d.escapeString(s.globals.seriesNames[b])),
									rel: a + 1,
									"data:realIndex": b
								}),
								k = i.graphics.group({
							...
							l = S.y, v = S.barHeight, g = S.yDivision, p = S.zeroW, o = S.x, y = S.barWidth, u = S.xDivision, f = S.zeroH, i.yArrj = [], i.yArrjF = [], i.yArrjVal = [], i.xArrj = [], i.xArrjF = [], i.xArrjVal = [];
							for (var C = function (e) {
									s.config.stroke.show && (A = i.isNullValue ? 0 : Array.isArray(i.strokeWidth) ? i.strokeWidth[b] : i.strokeWidth);
									var r = null;
									r = i.isHorizontal ? i.drawBarPaths({
										...
										strokeWidth: A,
										elSeries: w
									}), h = r.pathTo, c = r.pathFrom, l = r.y, o = r.x, x.push(o), m.push(l);
									var d = s.config.plotOptions.bar.distributed ? e : a,
										S = null;
									i.barOptions.colors.ranges.length > 0 && i.barOptions.colors.ranges.map(function (i, s) {
										t[a][e] >= i.from && t[a][e] <= i.to && (S = i.color)
									});
									var C = i.fill.fillPath({
										seriesNumber: i.barOptions.distributed ? d : b,
										color: S
									});
									w = i.renderSeries({
										realIndex: b,
								...
								}, L = 0; L < s.globals.dataPoints; L++) C(L);
							s.globals.seriesXvalues[b] = x, s.globals.seriesYvalues[b] = m, i.prevY.push(i.yArrj), i.prevYF.push(i.yArrjF), i.prevYVal.push(i.yArrjVal), i.prevX.push(i.xArrj), i.prevXF.push(i.xArrjF), i.prevXVal.push(i.xArrjVal), r.add(w)
						}, c = 0, u = 0; c < t.length; c++, u++) h(c, u);
					return r
				}
			}, {
				key: "initialPositions",
				value: function (t, e, i, s, a, n) {
					var r, o, l = this.w;
					return this.isHorizontal ? (r = (r = s = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight) / 100, n = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0), e = (s - r) / 2) : (o = i = l.globals.gridWidth / l.globals.dataPoints, l.globals.isXNumeric ? (this.minXDiff = this.bar.calcMinimumXDiff(), o = (i = this.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth) / 100) : o = o * parseInt(l.config.plotOptions.bar.columnWidth) / 100, a = this.baseLineY[this.yaxisIndex] + (this.isReversed ? l.globals.gridHeight : 0) - (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), t = l.globals.padHorizontal + (i - o) / 2), {
						x: t,
						y: e,
						yDivision: s,
						xDivision: i,
				...
				value: function (t) {
					...
					if (f > 0) {
						var y = o;
						this.prevXVal[f - 1][p] < 0 ? y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] + b - 2 * (this.isReversed ? b : 0) : this.prevX[f - 1][p] : this.prevXVal[f - 1][p] >= 0 && (y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] : this.prevX[f - 1][p] - b + 2 * (this.isReversed ? b : 0)), e = y
					} else e = o;
			...
			return r(i, z), s(i, [{
				...
				value: function (t, e) {
					...
					for (var r = s.group({
						...
						x = L.y, k = L.barHeight, p = L.x, S = L.barWidth, h = L.xDivision, c = L.zeroH, b.push(p + S / 2);
						for (var z = s.group({
								class: "apexcharts-datalabels"
							}), M = 0, P = i.globals.dataPoints; M < i.globals.dataPoints; M++, P--) {
							void 0 === this.series[o][M] || null === t[o][M] ? this.isNullValue = !0 : this.isNullValue = !1, i.config.stroke.show && (C = this.isNullValue ? 0 : Array.isArray(this.strokeWidth) ? this.strokeWidth[y] : this.strokeWidth);
							...
							u = T.pathTo, g = T.pathFrom, x = T.y, p = T.x, E = T.color, M > 0 && b.push(p + S / 2), m.push(x);
							var X = a.fillPath({
									seriesNumber: y,
									color: E
								}),
						...
						i.globals.seriesXvalues[y] = b, i.globals.seriesYvalues[y] = m, r.add(w)
					}
					return r
				}
			}, {
				...
				value: function (t) {
					...
					for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
						...
						if (e.config.chart.dropShadow.enabled) {
							...
							new u(this.ctx).dropShadow(c, g)
						}
						for (var p = 0, x = 0; x < l[h].length; x++) {
							var m = 1,
								b = this.determineHeatColor(h, x);
							if (e.globals.hasNegs) {
								var v = e.config.plotOptions.heatmap.shadeIntensity;
								m = b.percent < 0 ? 1 - (1 + b.percent / 100) * v : (1 - b.percent / 100) * v
							} else m = 1 - b.percent / 100;
							var y = b.color;
							if (e.config.plotOptions.heatmap.enableShades) {
								var w = new d;
								y = d.hexToRgba(w.shadeColor(m, b.color), e.config.fill.opacity)
							}
		...
		I = function () {
			...
			return s(t, [{
				...
				value: function (e, i) {
					...
					if (i.total.show && s.globals.series.length > 1) new t(this.ctx).printInnerLabels(i, i.total.label, i.total.formatter(s));
		...
		O = function () {
			function t(i, s, a) {
				e(this, t), this.ctx = i, this.w = i.w, this.xyRatios = s, this.pointsChart = !("bubble" !== this.w.config.chart.type && "scatter" !== this.w.config.chart.type) || a, this.scatter = new C(this.ctx), this.noNegatives = this.w.globals.minX === Number.MAX_VALUE, this.yaxisIndex = 0
			}
			return s(t, [{
				key: "draw",
				value: function (t, e, i) {
					...
					for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], m = [], b = 0, y = 0; y < t.length; y++) {
						if ("line" === o && ("gradient" === s.config.fill.type || "gradient" === s.config.fill.type[y]) && h.seriesHaveSameValues(y)) {
							var w = t[y].slice();
							w[w.length - 1] = w[w.length - 1] + 1e-6, t[y] = w
						}
						var k = s.globals.gridWidth / s.globals.dataPoints,
							C = s.globals.comboCharts ? i[y] : y;
						c.length > 1 && (this.yaxisIndex = C), this.isReversed = s.config.yaxis[this.yaxisIndex] && s.config.yaxis[this.yaxisIndex].reversed;
						var z = [],
							M = [],
							P = s.globals.gridHeight - p[this.yaxisIndex] - (this.isReversed ? s.globals.gridHeight : 0) + (this.isReversed ? 2 * p[this.yaxisIndex] : 0),
							E = P;
						P > s.globals.gridHeight && (E = s.globals.gridHeight), b = k / 2;
						var T = s.globals.padHorizontal + b,
							X = 1;
						s.globals.isXNumeric && (T = (s.globals.seriesX[C][0] - s.globals.minX) / g), M.push(T);
						var I = void 0,
							Y = void 0,
							F = void 0,
							O = void 0,
							...
							R = [],
							N = a.group({
								class: "apexcharts-series ".concat(d.escapeString(s.globals.seriesNames[C]))
							}),
							H = a.group({
						...
						var V = t[y].length === s.globals.dataPoints;
						N.attr({
						...
						if (j = this.determineFirstPrevY({
								...
								prevSeriesY: m,
								lineYPosition: q
							}).prevY, z.push(j), G = j, null === t[y][0]) {
							for (var U = 0; U < t[y].length; U++)
								if (null !== t[y][U]) {
									_ = k * U, j = P - t[y][U] / c[this.yaxisIndex], I = a.move(_, j), Y = a.move(_, E);
									break
								}
						} else I = a.move(_, j), Y = a.move(_, E) + a.line(_, j);
						if (F = a.move(-1, P) + a.line(-1, P), O = a.move(-1, P) + a.line(-1, P), s.globals.previousPaths.length > 0) {
							var Z = this.checkPreviousPaths({
								pathFromLine: F,
								pathFromArea: O,
								realIndex: C
							});
							F = Z.pathFromLine, O = Z.pathFromArea
						}
						for (var $ = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, J = 0; J < $; J++) {
							if (s.globals.isXNumeric) {
								var Q = s.globals.seriesX[C][J + 1];
								void 0 === s.globals.seriesX[C][J + 1] && (Q = s.globals.seriesX[C][$ - 1]), T = (Q - s.globals.minX) / g
							} else T += k;
							var K = d.isNumber(s.globals.minYArr[C]) ? s.globals.minYArr[C] : s.globals.minY;
							s.config.chart.stacked ? (q = y > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? m[y - 1][J + 1] : P, X = void 0 === t[y][J + 1] || null === t[y][J + 1] ? q - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : q - t[y][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[y][J + 1] / c[this.yaxisIndex] : 0)) : X = void 0 === t[y][J + 1] || null === t[y][J + 1] ? P - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : P - t[y][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[y][J + 1] / c[this.yaxisIndex] : 0), M.push(T), z.push(X);
							...
							R = tt.areaPaths, D = tt.linePaths, B = tt.pX, G = tt.pY, Y = tt.areaPath, I = tt.linePath, this.appendPathFrom && (F += a.line(T, P), O += a.line(T, P));
							...
							if (this.pointsChart) this.scatter.draw(N, J, {
								...
								var it = new S(this.ctx);
								s.globals.dataPoints > 1 && H.node.classList.add("hidden");
								var st = it.plotChartMarkers(et, C, J + 1);
								null !== st && H.add(st)
							}
							var at = !t[y][J + 1] || t[y][J + 1] > t[y][J] ? "top" : "bottom",
								nt = new L(this.ctx).drawDataLabel(et, C, J + 1, null, at);
							null !== nt && W.add(nt)
						}
						m.push(z), s.globals.seriesXvalues[C] = M, s.globals.seriesYvalues[C] = z, this.pointsChart || s.globals.delayedElements.push({
							el: H.node,
							index: C
						});
						var rt = {
						...
						if (s.config.stroke.show && !this.pointsChart) {
							...
							ct = "line" === o ? r.fillPath({
								seriesNumber: C,
								i: y
							}) : s.globals.stroke.colors[C];
							for (var dt = 0; dt < D.length; dt++) {
								var ut = a.renderPaths(n({}, rt, {
									pathFrom: F,
									pathTo: D[dt],
									stroke: ct,
									strokeWidth: Array.isArray(s.config.stroke.width) ? s.config.stroke.width[C] : s.config.stroke.width,
				...
				value: function (t) {
					var e = t.series,
						...
						x = this.w,
						m = new f(this.ctx),
						b = x.config.stroke.curve;
					if (Array.isArray(x.config.stroke.curve) && (b = Array.isArray(p) ? x.config.stroke.curve[p[i]] : x.config.stroke.curve[i]), "smooth" === b) {
						var v = .35 * (a - r);
						x.globals.hasNullValues ? (null !== e[i][s] && (null !== e[i][s + 1] ? (c = m.move(r, o) + m.curve(r + v, o, a - v, n, a + 1, n), d = m.move(r + 1, o) + m.curve(r + v, o, a - v, n, a + 1, n) + m.line(a, h) + m.line(r, h) + "z") : (c = m.move(r, o), d = m.move(r, o) + "z")), u.push(c), g.push(d)) : (c += m.curve(r + v, o, a - v, n, a, n), d += m.curve(r + v, o, a - v, n, a, n)), r = a, o = n, s === e[i].length - 2 && (d = d + m.curve(r, o, a, n, a, h) + m.move(a, n) + "z", x.globals.hasNullValues || (u.push(c), g.push(d)))
					} else null === e[i][s + 1] && (c += m.move(a, n), d = d + m.line(a - l, h) + m.move(a, n)), null === e[i][s] && (c += m.move(a, n), d += m.move(a, h)), "stepline" === b ? (c = c + m.line(a, null, "H") + m.line(null, n, "V"), d = d + m.line(a, null, "H") + m.line(null, n, "V")) : "straight" === b && (c += m.line(a, n), d += m.line(a, n)), s === e[i].length - 2 && (d = d + m.line(a, h) + m.move(a, n) + "z", u.push(c), g.push(d));
					return {
						linePaths: u,
						areaPaths: g,
						pX: r,
		...
		D = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					if (e.config.yaxis[t].reversed && d.reverse(), e.config.yaxis[t].labels.show)
						for (var u = o; u >= 0; u--) {
							var g = d[u];
							g = c(g, u);
							...
							r.add(x);
							var m = i.rotateAroundCenter(x.node);
					...
					if (w.show) {
						...
						n.add(A), this.drawAxisTicks(k, o, w, e.config.yaxis[t].axisTicks, t, l, n)
					}
					return n
				}
			}, {
				...
				value: function (t) {
					...
					if (e.config.yaxis[t].reversed && h.reverse(), e.config.xaxis.labels.show)
						for (var c = n; c >= 0; c--) {
							var d = h[c];
							d = l(d, c);
							var u = i.drawText({
					...
					var m = e.config.yaxis[t].axisBorder;
					if (m.show) {
						var b = i.drawLine(e.globals.padHorizontal + m.offsetX, 1 + m.offsetY, e.globals.padHorizontal + m.offsetX, e.globals.gridHeight + m.offsetY, m.color);
						s.add(b)
					}
					return s
				}
				...
				value: function () {
					...
					return t.globals.xLabelFormatter = function (t) {
						...
						void 0 !== e.labels.formatter ? t.globals.yLabelFormatters[i] = e.labels.formatter : t.globals.yLabelFormatters[i] = function (i) {
							return d.isNumber(i) ? 0 !== t.globals.yValueDecimal || t.globals.maxY - t.globals.minY < 4 ? i.toFixed(e.decimalsInFloat) : i.toFixed(0) : i
						}
					}), t.globals
				}
			}, {
			...
			return s(t, [{
					...
					if (e.config.xaxis.labels.show)
						for (var d = 0; d <= c - 1; d++) {
							var u = void 0 === r[d] ? "" : r[d],
								g = void 0;
							g = new R(this.ctx).xLabelFormat(l, u), void 0 !== h && (g = h(u, this.xaxisLabels[d], d));
							var p = n - t / 2 + e.config.xaxis.labels.offsetX;
							e.globals.timelineLabels.length > 0 ? (p = e.globals.timelineLabels[d].position, g = e.globals.timelineLabels[d].value) : "datetime" === e.config.xaxis.type && void 0 === h && (g = ""), void 0 === g && (g = ""), (0 === (g = g.toString()).indexOf("NaN") || 0 === g.toLowerCase().indexOf("invalid") || g.toLowerCase().indexOf("infinity") >= 0 || this.drawnLabels.indexOf(g) >= 0 && !e.config.xaxis.labels.showDuplicates) && (g = ""), this.drawnLabels.push(g);
							var x = 28;
				...
				value: function (t) {
					...
					if (s.config.xaxis.axisBorder.show) {
						...
						r.add(b), new D(this.ctx).drawAxisTicks(0, l.length, s.config.yaxis[0].axisBorder, s.config.yaxis[0].axisTicks, 0, e, r)
					}
					return r
				}
			}, {
		...
		H = function () {
			...
			return s(t, [{
				...
				value: function (t, e) {
					...
					var r = s + 1;
					r < 2 ? r = 2 : r > 2 && (r -= 2);
					for (var o = n / r, l = Math.floor(d.log10(o)), h = Math.pow(10, l), c = parseInt(o / h) * h, u = c * Math.floor(t / c), g = c * Math.ceil(e / c), f = u; a.push(f), !((f += c) > g););
					...
					var p = t;
					(a = []).push(p);
					for (var x = Math.abs(e - t) / s, m = 0; m <= s - 1; m++) p += x, a.push(p);
					return {
						result: a,
						niceMin: a[0],
						niceMax: a[a.length - 1]
			...
			return s(t, [{
				...
				value: function (t) {
					...
					for (var c = t; c < s; c++) {
						...
						for (var u = 0; u < a.series[c].length; u++) null !== o[c][u] && d.isNumber(o[c][u]) ? (n = Math.max(n, h[c][u]), e = Math.min(e, l[c][u]), i = Math.max(i, l[c][u]), "candlestick" === this.w.config.chart.type && (n = Math.max(n, a.seriesCandleO[c][u]), n = Math.max(n, a.seriesCandleH[c][u]), n = Math.max(n, a.seriesCandleL[c][u]), i = n = Math.max(n, a.seriesCandleC[c][u])), d.isFloat(o[c][u]) && (a.yValueDecimal = Math.max(a.yValueDecimal, o[c][u].toString().split(".")[1].length)), r > l[c][u] && l[c][u] < 0 && (r = l[c][u])) : a.hasNullValues = !0
					}
					return {
						minY: r,
						maxY: n,
				...
				value: function () {
					...
					if (t.minY = n.minY, t.maxY = n.maxY, i = n.lowestY, e.chart.stacked) {
						for (var r = [], o = [], l = 0; l < t.series[t.maxValsInArrayIndex].length; l++)
							for (var h = 0, c = 0, u = 0; u < t.series.length; u++) null !== t.series[u][l] && d.isNumber(t.series[u][l]) && (t.series[u][l] > 0 ? h = h + parseFloat(t.series[u][l]) + 1e-4 : c += parseFloat(t.series[u][l])), u === t.series.length - 1 && (r.push(h), o.push(c));
					...
					}), this.isBarHorizontal && (void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (t.minY = e.xaxis.min), void 0 !== e.xaxis.max && "number" == typeof e.xaxis.max && (t.maxY = e.xaxis.max)), t.isMultipleYAxis ? (this.scales.setMultipleYScales(), t.minY = i, t.yAxisScale.forEach(function (e, i) {
		...
		B = function () {
			function t(i) {
				e(this, t), this.ctx = i, this.w = i.w, this.lgRect = {}, this.yAxisWidth = 0, this.xAxisHeight = 0, this.isSparkline = this.w.config.chart.sparkline.enabled, this.xPadRight = 0, this.xPadLeft = 0, this.isBarHorizontal = !("bar" !== this.w.config.chart.type || !this.w.config.plotOptions.bar.horizontal)
			}
			return s(t, [{
				key: "plotCoords",
				value: function () {
				...
				value: function (t, e) {
					var i = this.w;
					this.xAxisHeight = (t.height + e.height) * i.globals.LINE_HEIGHT_RATIO + 15, this.xAxisWidth = t.width, this.xAxisHeight - e.height > i.config.xaxis.labels.maxHeight && (this.xAxisHeight = i.config.xaxis.labels.maxHeight), i.config.xaxis.labels.minHeight && this.xAxisHeight < i.config.xaxis.labels.minHeight && (this.xAxisHeight = i.config.xaxis.labels.minHeight), i.config.xaxis.floating && (this.xAxisHeight = 0), this.isBarHorizontal ? this.yAxisWidth = i.globals.yLabelsCoords[0].width + i.globals.yTitleCoords[0].width + 15 : this.yAxisWidth = this.getTotalYAxisWidth();
					var s = 0,
						a = 0;
				...
				value: function (t) {
					...
					}), this.conditionalChecksForAxisCoords(a, r), i.translateXAxisY = e.globals.rotateXLabels ? this.xAxisHeight / 1 : -4, i.translateXAxisX = e.globals.rotateXLabels && e.globals.isXNumeric && e.config.xaxis.labels.rotate <= -45 ? -this.xAxisWidth / 4 : 0, this.isBarHorizontal && (i.rotateXLabels = !1, i.translateXAxisY = parseInt(e.config.xaxis.labels.style.fontSize) / 1.5 * -1), i.translateXAxisY = i.translateXAxisY + e.config.xaxis.labels.offsetY, i.translateXAxisX = i.translateXAxisX + e.config.xaxis.labels.offsetX;
					...
					this.setGridXPosForDualYAxis(n, s), new D(this.ctx).setYAxisXPosition(s, n)
				}
			}, {
				...
				value: function (t) {
					var e = this,
						i = this.w;
					if ("category" === i.config.xaxis.type && this.isBarHorizontal || "numeric" === i.config.xaxis.type) {
				...
				value: function () {
					var t, e = this,
						i = this.w,
						s = i.globals.labels.slice();
					if (i.globals.timelineLabels.length > 0) {
						...
						var n = "left" !== i.config.legend.position || "right" !== i.config.legend.position || i.config.legend.floating ? 0 : this.lgRect.width,
							r = [],
							o = i.globals.xLabelFormatter;
						s.forEach(function (t) {
							var i = new R(e.ctx).xLabelFormat(o, t);
							r.push(i)
						});
						var l = r.reduce(function (t, e) {
							return t.length > e.length ? t : e
						}, 0);
						this.isBarHorizontal && (l = i.globals.yAxisScale[0].result.reduce(function (t, e) {
							return t.length > e.length ? t : e
						}, 0)), l = new R(this.ctx).xLabelFormat(o, l);
						var h = new f(this.ctx),
							c = h.getTextRects(l, i.config.xaxis.labels.style.fontSize);
						(t = {
							width: c.width,
							height: c.height
						}).width * s.length > i.globals.svgWidth - n - this.yAxisWidth && 0 !== i.config.xaxis.labels.rotate ? this.isBarHorizontal || (i.globals.rotateXLabels = !0, c = h.getTextRects(l, i.config.xaxis.labels.style.fontSize, i.config.xaxis.labels.style.fontFamily, "rotate(".concat(i.config.xaxis.labels.rotate, " 0 0)"), !1), t.height = c.height / 1.66) : i.globals.rotateXLabels = !1
					}
					return i.config.xaxis.labels.show || (t = {
						width: 0,
						height: 0
					}), {
						width: t.width,
		...
		G = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					e.globals.timelineLabels = s.slice(), new B(this.ctx).plotCoords()
				}
			}, {
		...
		_ = function () {
			...
			return s(t, [{
				...
				value: function (t, e) {
					...
					for (var r = 0; r < t[e].data.length; r++) void 0 !== t[e].data[r].y && (Array.isArray(t[e].data[r].y) && 4 === t[e].data[r].y.length ? this.twoDSeries.push(d.parseNumber(t[e].data[r].y[3])) : this.twoDSeries.push(d.parseNumber(t[e].data[r].y)));
					for (var o = 0; o < t[n].data.length; o++) {
						var l = "string" == typeof t[n].data[o].x,
							h = !!a.isValidDate(t[n].data[o].x.toString());
						l || h ? l ? "datetime" === i.xaxis.type ? this.twoDSeriesX.push(a.parseDate(t[n].data[o].x)) : (this.fallbackToCategory = !0, this.twoDSeriesX.push(t[n].data[o].x)) : "datetime" === i.xaxis.type ? this.twoDSeriesX.push(a.parseDate(t[n].data[o].x.toString())) : this.twoDSeriesX.push(parseFloat(t[n].data[o].x)) : this.twoDSeriesX.push(t[n].data[o].x)
					}
				...
				value: function (t) {
					for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx, i = this.w.config, s = this.w.globals, a = new T(e), n = 0; n < t.length; n++) {
				...
				value: function (t) {
					...
					if (e.xaxis.categories.length > 0) i.labels = e.xaxis.categories;
						...
						var s = [];
						if (i.axisCharts) {
							if (this.twoDSeriesX.length > 0) s = new H(this.ctx).linearScale(this.twoDSeriesX[0], this.twoDSeriesX[this.twoDSeriesX.length - 1], e.xaxis.tickAmount ? e.xaxis.tickAmount : 6).result.map(function (t) {
								return t.toFixed(1)
							});
							else
				...
				value: function (t, e) {
					var i, s, a = this.w.globals,
						...
						r = new N(this.ctx),
						o = new D(this.ctx);
					a.axisCharts && "radar" !== t && ("bar" === t && n.plotOptions.bar.horizontal ? (s = o.drawYaxisInversed(0), i = r.drawXaxisInversed(0), a.dom.elGraphical.add(i), a.dom.elGraphical.add(s)) : (i = r.drawXaxis(), a.dom.elGraphical.add(i), n.yaxis.map(function (t, e) {
	...
	var et, it, st = function () {
				...
				value: function () {
					...
					if (!(!t.config.plotOptions.bar.horizontal || "bar" !== t.config.chart.type)) {
						...
						if (t.config.grid.yaxis.lines.show)
							for (var p = 0, x = 0, m = t.globals.gridWidth, b = 0; b < t.globals.dataPoints + 1; b++) {
								var v = e.drawLine(0, p, m, x, t.config.grid.borderColor, i);
						...
						if (r = this.xaxisLabels.length, t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) {
							...
							if (t.globals.timelineLabels.length > 0)
								for (var A = 0; A < r; A++) {
									...
									new N(this.ctx).drawXaxisTicks(w, s)
								} else
						...
						if (t.config.grid.yaxis.lines.show)
							for (var P = 0, E = 0, T = t.globals.gridWidth, X = 0; X < o + 1; X++) {
								var I = e.drawLine(0, P, T, E, t.config.grid.borderColor, i);
		...
		nt = function () {
			...
			return s(t, [{
				...
				value: function () {
					...
					for (var n = t.globals.legendFormatter, r = 0; r <= i.length - 1; r++) {
						...
						var g = t.config.legend.markers.offsetX,
							...
							k = u.style;
						k.background = s[r], k.color = s[r], k.height = Array.isArray(x) ? parseFloat(x[r]) + "px" : parseFloat(x) + "px", k.width = Array.isArray(m) ? parseFloat(m[r]) + "px" : parseFloat(m) + "px", k.left = Array.isArray(g) ? g[r] : g, k.top = Array.isArray(p) ? p[r] : p, k.borderWidth = Array.isArray(b) ? b[r] : b, k.borderColor = Array.isArray(y) ? y[r] : y, k.borderRadius = Array.isArray(w) ? parseFloat(w[r]) + "px" : parseFloat(w) + "px", t.config.legend.markers.customHTML && (Array.isArray(t.config.legend.markers.customHTML) ? u.innerHTML = t.config.legend.markers.customHTML[r]() : u.innerHTML = t.config.legend.markers.customHTML()), f.setAttrs(u, {
							rel: r + 1,
							"data:collapsed": l || h
				...
				value: function (t) {
					...
					if ("heatmap" !== e.config.chart.type) !t.target.classList.contains("inactive-legend") && i && new V(this.ctx).toggleSeriesOnHover(t, t.target);
					else if (i) {
						var s = parseInt(t.target.getAttribute("rel")) - 1;
						this.ctx.fireEvent("legendHover", [this.ctx, s, this.w]), new V(this.ctx).highlightRangeInSeries(t, t.target)
					}
				}
			}, {
				key: "onLegendClick",
						...
						var n = new y({}),
							r = function () {
								...
								if (r > s) {
									...
									for (var l = 0; l < a.length; l++) r < a[l].breakpoint && (t = v.extendArrayProps(n, a[l].options), t = d.extend(i.config, t), e.overrideResponsiveOptions(t))
							};
						if (t) {
		...
		lt = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					for (var e = 0, i = new v(this.ctx), s = t.map(function (t, e) {
		...
		ht = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					var c = n;
					s.globals.isXNumeric && "datetime" === s.config.xaxis.type ? n = new R(this.ctx).xLabelFormat(s.globals.ttKeyFormatter, c) : n = s.globals.xLabelFormatter(c, l);
		...
		ct = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					e = new V(this.ctx).getActiveSeriesIndex();
		...
		ut = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					if (s.target.classList.contains("apexcharts-marker")) {
						...
						if (l.tooltipLabels.drawSeriesTexts({
							...
							}), "mouseup" === s.type && l.markerClick(s, e, i), l.marker.enlargeCurrentPoint(i, a.paths), n = h, r = c - 1.4 * l.tooltipRect.ttHeight, l.w.config.tooltip.followCursor) {
				...
				value: function (t) {
					...
					var u = d.barHeight,
						g = d.j;
					if (r.isBarHorizontal && r.hasBars() || !n.config.tooltip.shared ? (h = d.x, c = d.y, i = Array.isArray(n.config.stroke.width) ? n.config.stroke.width[e] : n.config.stroke.width, l = h) : n.globals.comboCharts || n.config.tooltip.shared || (l /= 2), isNaN(c) && (c = n.globals.svgHeight - r.tooltipRect.ttHeight), h + r.tooltipRect.ttWidth > n.globals.gridWidth ? h -= r.tooltipRect.ttWidth : h < 0 && (h += r.tooltipRect.ttWidth), r.w.config.tooltip.followCursor) {
						var f = r.getElGrid().getBoundingClientRect();
						c = r.e.clientY - f.top
					}
					if (null === r.tooltip && (r.tooltip = n.globals.dom.baseEl.querySelector(".apexcharts-tooltip")), n.config.tooltip.shared || (n.globals.comboChartsHasBars ? r.tooltipPosition.moveXCrosshairs(l + i / 2) : r.tooltipPosition.moveXCrosshairs(l)), !r.fixedTooltip && (!n.config.tooltip.shared || r.isBarHorizontal && r.hasBars())) {
						...
						var p = parseInt(a.paths.parentNode.getAttribute("data:realIndex")),
							x = n.globals.isMultipleYAxis ? n.config.yaxis[p].reversed : n.config.yaxis[0].reversed;
						!x || r.isBarHorizontal && r.hasBars() || (c = c + u - 2 * (n.globals.series[e][g] < 0 ? u : 0)), r.tooltipRect.ttHeight + c > n.globals.gridHeight ? (c = n.globals.gridHeight - r.tooltipRect.ttHeight + n.globals.translateY, o.style.top = c + "px") : o.style.top = c + n.globals.translateY - r.tooltipRect.ttHeight / 2 + "px"
					}
				}
			}, {
				key: "getBarTooltipXY",
				value: function (t) {
					...
					if (d.contains("apexcharts-bar-area") || d.contains("apexcharts-candlestick-area")) {
						var u = e.target,
						...
						}), s.config.tooltip.followCursor ? s.config.plotOptions.bar.horizontal ? (o = v - f.left + 15, l = b - n.dataPointsDividedHeight + p / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? m - x / 2 : m - n.dataPointsDividedWidth + x / 2, l = e.clientY - f.top - n.tooltipRect.ttHeight / 2 - 15) : s.config.plotOptions.bar.horizontal ? ((o = m) < n.xyRatios.baseLineInvertedY && (o = m - n.tooltipRect.ttWidth), l = b - n.dataPointsDividedHeight + p / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? m - x / 2 : m - n.dataPointsDividedWidth + x / 2, l = b)
					}
					return {
						x: o,
						y: l,
		...
		ft = function () {
			...
			return s(t, [{
				...
				value: function (t) {
					...
					}, i.e = a, !i.hasBars() || n.globals.comboCharts || i.isBarShared) || n.config.tooltip.onDatasetHover.highlightDataSeries && new V(e).toggleSeriesOnHover(a, a.target.parentNode);
				...
				value: function (t) {
					...
					if (this.clientY = c, this.clientX = h, c < l.top || c > l.top + l.height) this.handleMouseOut(n);
						...
						if ("bar" === r.config.chart.type && this.isBarHorizontal && this.hasBars() && (g = !1), "mousemove" === a.type || "touchmove" === a.type || "mouseup" === a.type) {
					...
					if (s.config.yaxis.forEach(function (t, e) {
						...
						if (s.globals.zoomEnabled) {
							...
							if (r) {
								...
								m && (p = m.xaxis ? m.xaxis : p, f = m.yaxis ? m.yaxe : f)
							}
	...
	et = "undefined" != typeof window ? window : void 0, it = function (e, i) {
		...
		}) : "object" === ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module ? module.exports = et.document ? it(et, et.document) : function (t) {
				...
				switch (t[0]) {
					...
					case "A":
						t = (e = function (t, e) {
							...
							for (k = 1, A = m.length; k < A; k++) w = m[k - 1][2], S = w.x, C = w.y, w = m[k][0], L = w.x, z = w.y, w = m[k][1], I = w.x, Y = w.y, D.push(["C", S, C, L, z, I, Y]);
							return D
						}(this.pos, t))[0]
				}
		...
		function () {
			...
			return s(i, [{
				...
				value: function (t) {
					...
					return i.push(t), this.revertDefaultAxisMinMax(), this._updateSeries(i, e)
				}
			}, {
				key: "_updateSeries",
				value: function (t, e) {
