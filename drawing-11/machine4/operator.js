 ...
 for (var i = 0; i < product_list.length; i++) {
   ...
   if (output_check == 0) {
      ...
      //**********************this comment when Q/A available************
       document.getElementById('start1').value = "/usr/sdext/Factory/machines/machine4/table2.shtm";
      //**********************END****************************
...
for (var i = 0; i < product_list.length; i++) {
   ...
   if (output_check == 0) {
      ...
      //**********************this comment when Q/A available************
      document.getElementById('start2').value = "/usr/sdext/Factory/machines/machine4/table2.shtm";
      //**********************END**************************** 
...
function subform() {
   //**************comment this when Q/A AVAILABLE ****************
    document.getElementById('qtr1').value = "/usr/sdext/Factory/machines/machine4/table2.shtm";
   //***************************END********************
...
function subform1() {
   //**************comment this when Q/A AVAILABLE ****************
    document.getElementById('qtr2').value = "/usr/sdext/Factory/machines/machine4/table2.shtm";
   //***************************END********************
   var prod_info = document.getElementById("out_code1").innerHTML;
   if (prod_info == "Nil") {
      swal({
